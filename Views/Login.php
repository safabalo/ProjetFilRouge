    ...
    <section class="w-50 ms-5">
        <form action="" method="post" class="w-50 formulaire_login">
            ...
            <div class="form-group mb-4 d-flex justify-content-center">
                <button type="submit" class="btn sub text-white">Se connecter</button>
            </div>
            <div class="d-flex justify-content-around">
                <a href="https://mail.google.com/" class="btn">
                    <img src="../Assets/SVG&PNG/googleicon.png" alt="" width="30px" height="30px" class="signicons">
                </a>
                <a href="https://facebook.com" class="btn">
                    <img src="../Assets/SVG&PNG/Facebook_icon.png" alt="" width="30px" height="30px" class="signicons">
                </a>
                <a href="https://twitter.com" class="btn">
                    <img src="../Assets/SVG&PNG/twitter.png" alt="" width="30px" height="30px" class="signicons">
                </a> 
            </div> 
        </form> 
    </section>
