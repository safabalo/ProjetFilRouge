                            ...
                            <div class="modal-content"> -->
                                <form method="POST">
                                    <!-- <div class="modal-header">						 -->
                                        <!-- <h4 class="modal-title">Edité un Docteur</h4> -->
                                        <h4>Edite</h4>
                                    ...
                                    <!-- <div class="modal-body"> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="specialite" name="specialite" placeholder="specialite" required value="<?php echo $doctor->specialite?>">
